...
\begin{tabular}{c|c|c|c}
	& & & \\
	 & Max. Biegesp. $\sigma_{b,max}$ & Max. Durchb. $f$ & Federrate $c$ \\ 
	 \hline 
	& & & \\
 Rechteckfeder $b=b'$	& $\frac{6\cdot F \cdot L}{b \cdot s^2}$ & $4 \cdot \frac{F \cdot l^3}{E \cdot b \cdot s^3}$ & $\frac{b \cdot s^3 \cdot E}{4 \cdot l^3}$ \\ 
	& & & \\
 Trapezfeder	 & $\frac{6\cdot F \cdot L}{b \cdot s^2}$ & $4 \cdot X \cdot \frac{F \cdot l^3}{E \cdot b \cdot s^3}$ & $\frac{b \cdot s^3 \cdot E}{4 \cdot X \cdot l^3}$ \\ 
	& & & \\
 Dreiecksfeder $b'=0$	& $\frac{6\cdot F \cdot L}{b\cdot s^2}$ & $6 \cdot \frac{F \cdot l^3}{E \cdot b \cdot s^3}$ & $\frac{b \cdot s^3 \cdot E}{6 \cdot l^3}$ \\ 
\end{tabular} 
